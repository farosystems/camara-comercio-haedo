...
export async function PUT(
  ...
  try {
    ...
    const socioData = {
      ...
      fecha_alta: body.fecha_alta && body.fecha_alta !== "" ? body.fecha_alta : null,
      fecha_baja: body.fecha_baja && body.fecha_baja !== "" ? body.fecha_baja : null,
      fecha_nacimiento: body.fecha_nacimiento && body.fecha_nacimiento !== "" ? body.fecha_nacimiento : null,
